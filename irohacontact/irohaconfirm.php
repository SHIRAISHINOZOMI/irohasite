...
<tr>
<td>いろはに参加したことはありますか？(Are you a member of Iroha?)</td>
<td>
    <?php 
     if($YESNO===1){
         echo 'はい(yes)'; 
...
<tr>
<td>何回くらい参加しましたか？(Have many weekly sessions have you taken part in?)</td>
<td>
    <?php 
     if($times===1){
         echo '一回(Once)'; 
...
<tr>    
<td>どこでいろはについて知りましたか？(How did you first hear of Iroha)</td>
<td>
